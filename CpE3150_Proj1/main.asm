...
START:	  OUT DDRA, R16 ; pull-up resistors
		  ...
		  CHECK_SW4:
			...
			JMP CHECK_SW6 ; jump to switch 7
			LDI R31, 10
YEET:		CALL RAVE_MODE ; rave mode x5
	    ...
	    CHECK_SW6:
			SBIC PINA,4 ; checking sw5 pin
			JMP  CHECK_SW7 ; check if switch 7 is  pressed
			CALL MORSE_CODE ; play morse code
...
;plays approximately g5 for a short time
MORSE_SHORT:	LDI R25, 30
SHORT_L2:		LDI R26, 10
SHORT_L1:		SBI PORTE, 4; set pe4 to high
				CALL TONEDELAY_G5
				CBI PORTE, 4; set pe4 to low
				CALL TONEDELAY_G5
				DEC R26
...
;plays approximately g5 for a longer time
MORSE_LONG:	LDI R25, 30
LONG_L2:		LDI R26, 20
LONG_L1:		SBI PORTE, 4; set pe4 to high
				CALL TONEDELAY_G5
				CBI PORTE, 4; set pe4 to low
				CALL TONEDELAY_G5
				DEC R26
